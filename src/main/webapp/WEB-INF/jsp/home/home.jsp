...
<body style="background-color: #f6e5c7">
	...
	<div class="container" style="background-color: #f6e5c7">
		<div class="row" >
		...
		<div class="container" >
			<h1 class="jumbotron text-center">Bem
				vindo ao PS13SI</h1>
			<div class="row" >
				<div class="col-md-3" >
					<img src="${contextPath}/image/boot4.jpg" width="1200px"
						height="300px">
				</div>
		...
		<h4>a PS13SI é uma startup que consiste na criação e formação de
			...
			Machine Learning, IA e outras.
			Os Bootcamps da PS13SI envolvem um plano de treinamento
		...
		<div class="row"></div>
				<div class="col-md-3">
					<img src="${contextPath}/image/boot5.jpg" width="1200px"
						height="400px">
				</div>
